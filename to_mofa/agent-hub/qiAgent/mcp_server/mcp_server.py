...
def list_files():
    ...
    current_dir = "C:/Users/seven/Desktop/qiAgent/to_mofa/agent-hub/qiAgent/classified_data"
...
def read_file(filename):
    ...
    filename = "C:/Users/seven/Desktop/qiAgent/to_mofa/agent-hub/qiAgent/classified_data/" + filename
    result = []
    try:
        # 检查文件是否存在
